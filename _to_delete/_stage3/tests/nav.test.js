...
/* The hands-on tools sit together: watch it run, work on it, build one,
   diagnose one — then the two secondary entries. */
const EXPECTED_ORDER = ["home", "learn", "sim", "service", "build", "diagnose", "teach", "about"];
