...
The Code is not advice. In Australia it is **referenced in a Determination**
under the *Ozone Protection and Synthetic Greenhouse Gas Management
Regulations 1995*. Its mandatory requirements are given force through the
*Ozone Protection and Synthetic Greenhouse Gas Management Act 1989*, the
Regulations, and the conditions attached to your licence. Other requirements
...
Sections on recovery, recycling, reclamation, handling and storage, and
Appendices A and B on refrigerants, are **identical in both Parts**. So the
rules for what you do with the gas once it is out of the machine do not change
        ...
        quiz: [
          ...
          },
          {
            ...
            options: [
              ...
              "It is referenced in a Determination under the Ozone Protection and Synthetic Greenhouse Gas Management Regulations, and enforced through the Act, the Regulations and licence conditions",
              "Nothing — it is guidance only",
              "It is enforced by AIRAH as the publisher",
            ],
            answer: 1,
            explain: "The Code is referenced in a Determination under the Regulations. That, plus the Act and your permit conditions, is what turns its 'must' statements into legal obligations.",
          },
          {
...
- manufacturing, installing, commissioning, servicing and modifying RAC
equipment that contains, will be charged with, or will be manufactured
incorporating a scheduled refrigerant — **whether or not refrigerant is
present at the time**
...
**Apprentices and other trainees must hold a trainee licence and work under
the supervision of a fully qualified licence holder.** There is no informal
"helping out" tier.

### The business permit

A person or company must also be **appropriately authorised to acquire,
possess or dispose of bulk scheduled refrigerant** — the Refrigerant Trading
Authorisation. Holders of an RTA, and some licence holders, **must show their
...
The obligation runs to the employer as well as the technician. Anyone carrying
out this work must ensure that they and their employees who handle scheduled
refrigerant **are provided with a copy of this Code and work to the standards
set out in it**.
...
The Code is explicit that anyone working with scheduled *or* non-scheduled
refrigerants that present safety risks should be **competent to do so**, and
that some jurisdictions impose additional safety or licensing requirements for
certain non-scheduled refrigerants. Holding an RHL does not by itself make you
        ...
        quiz: [
          {
            ...
            answer: 1,
            explain: "The Code's scope explicitly includes installing and modifying equipment that contains, will be charged with, or will be manufactured incorporating a scheduled refrigerant — whether or not refrigerant is present at the time.",
          },
          {
            ...
            options: [
              ...
              "They must hold a trainee licence AND work under the supervision of a fully qualified licence holder",
              "Apprentices may handle refrigerant freely for the first year",
              "Only if the charge is under 2 kg",
            ],
            answer: 1,
            explain: "Trainees need a trainee licence and must work under the supervision of a fully qualified licence holder. Supervision is part of the requirement, not an optional extra.",
          },
          {
...
The Australian Act **prohibits conduct that results in, or is likely to
result in, the discharge of a scheduled substance to the atmosphere**
...
In **New Zealand** it is an offence under the *Ozone Layer Protection Act
1996* to wilfully release an ozone-depleting substance, and illegal to
release synthetic greenhouse gases under the *Climate Change Response Act*.
...
All refrigerants used in RAC equipment **must have been classified according
to AS/NZS ISO 817** — the safety classification system covered in the
flammability lesson of this module.
...
**Scheduled refrigerant must not be put into a system for the purposes of
pressure leak tightness testing.** Every section of a system built on site
must be leak tightness tested **before** the plant is charged.
...
- after the system is moved, altered, or its use changes
- after the system is repaired
- after a change in refrigerant type
- when a refrigerant leak or low charge is **known or suspected**
...
2. Connect the OFN cylinder to the system or isolated section.
...
`,
        quiz: [
          ...
          },
          {
            ...
            answer: 1,
            explain: "The Code notes standard-grade nitrogen is unsafe because of the possibility of sufficient oxygen to cause an explosion at high pressure. OFN is also specified as high purity, under 10 ppm moisture.",
          },
          {
...
**Where diagnostic analysis indicates a low charge, a leak tightness test must
be performed.** This is the clause that connects your gauge reading to a legal
obligation.
...
- **Leak detected** → all refrigerant must be removed from the system or
affected section, and the leak repaired.
- **Leak suspected but not detected** → all refrigerant must be removed, and
the system or affected section **leak tightness tested**.
...
`,
        quiz: [
          ...
          },
          {
            ...
            answer: 1,
            explain: "Where a leak is suspected but not detected, all refrigerant must be removed and the system or affected section leak tightness tested — the more sensitive test takes over.",
          },
          {
...
- **Must be in date** — the current date must not be later than the expiry of
the most recent test station stamp.
...
to a supplier or collection agent for safe disposal. In Australia it must be
recovered and recycled, or sent to an appropriately licensed facility for
reclamation or disposal. A Refrigerant Trading Authorisation holder **must
accept surrendered refrigerant** that appears intended for use in RAC
equipment.
        ...
        quiz: [
          ...
          },
          {
            ...
            options: [
              ...
              "not recover into it — the current date must not be later than the expiry of the most recent test stamp",
              "use it if it is under half full",
              "use it for vapour only",
            ],
            answer: 1,
            explain: "Refrigerant must not be recovered into an out-of-date recovery cylinder. The current date must not be later than the expiry date of the most recent test station stamp.",
          },
          {
...
- Refrigerant **must not be vented from the receiving cylinder**.
- The receiving cylinder **may be cooled** in an operating refrigerator or
freezer.
- Warming the discharging cylinder is permitted **under controlled
conditions**.
